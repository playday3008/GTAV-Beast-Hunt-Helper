...
pub const eFiringPattern = enum(windows.DWORD) {
...
pub const eWeapon = enum(windows.DWORD) {
...
pub const eWeaponGroup = enum(windows.DWORD) {
...
pub const ePickupType = enum(windows.DWORD) {
